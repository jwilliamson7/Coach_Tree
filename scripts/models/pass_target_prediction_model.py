...
def main():
    ...
    try:
        ...
        feature_names = mp.apply_feature_selection(feature_names, "models/pass_target/pass_target_prediction_model")
        ...
        split = mp.split_encode_impute(
            feature_data, feature_names, target_col='targets_ahead',
