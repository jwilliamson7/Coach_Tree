...
\citep{chen2016}; the residual definition of a gene is identical whether the model
...
\citep{nadeau2003} that account for the overlap among resampled training sets.
...
\citep{meinshausen2010}, keeping only features selected in at least 60\% of
...
random-effects estimator \citep{dersimonian1986}. Each coach-season enters its
...
Meinshausen, N., \& B\"uhlmann, P. (2010). Stability selection. \textit{Journal of
the Royal Statistical Society: Series B (Statistical Methodology)}, 72(4), 417--473.
...
\textit{Machine Learning}, 52(3), 239--281.
