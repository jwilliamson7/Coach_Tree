...
\parencite{meinshausen2010}, keeping only features selected in at least 60\% of
team-year subsamples, which prunes collinear inputs without materially changing
accuracy. Because the classifier genes are residuals from predicted probabilities,
...
\texttt{dffe2f1} \parencite{williamson2026war}.
