...
In the early period (2006-2011), aggressive tactics provided measurable performance benefits ($r=0.197$, $p=0.007$ for composite aggression). But by 2018-2024, the relationship was no longer statistically distinguishable from zero ($r=-0.018$, $p=0.790$).
...
Aggressive coaching caused measurable performance benefits in the early analytics era, and two-way fixed effects analysis establishes a persistent causal relationship. Controlling for coach quality and temporal trends, a one standard deviation increase in aggression corresponds to 0.235 additional WAR games ($p=0.020$, Cohen's $d=0.13$)---representing approximately 10\% of the interquartile range in the WAR distribution, a small but meaningful performance advantage. This pooled effect persists across the full 2006-2024 period, demonstrating that aggression causally affects performance.

Cross-sectional evidence shows clear temporal erosion: correlations between composite aggression and context-adjusted performance (WAR) declined from $r=0.197$ ($p=0.007$) in 2006-2011 to essentially zero ($r=-0.018$, $p=0.790$) in 2018-2024. Whether the causal effect itself has eroded remains less certain. Within-coach fixed effects show suggestive patterns---point estimates declining 49\% from 0.258 games in early to 0.131 games in late eras---but all era-specific effects are statistically non-significant and era-stratified analyses suffer from severe power limitations (27\%, 21\%, and 13\% power respectively), preventing definitive conclusions about temporal changes in the causal effect.
...
Coaching background matters for stability but not for performance. Both offensive and defensive head coaches show similar weak overall relationships between aggression and performance. Pass-heavy aggression shows statistically significant but small correlations with WAR for both groups ($r=0.136$, $p=0.016$ for offensive; $r=0.146$, $p=0.021$ for defensive), while composite aggression shows non-significant relationships for both ($r=0.074$, $p=0.192$ for offensive; $r=0.120$, $p=0.058$ for defensive). However, background profoundly affects stability: offensive coaches show nearly double the year-to-year persistence in fourth down philosophy compared to defensive coaches ($r=0.690$ vs $r=0.373$). For offensive coaches, aggression---especially fourth down decisions---represents deeply held strategic beliefs that persist across contexts. For defensive coaches making offensive decisions, aggression is more contextual and reactive, adapting to personnel and game situations.

The popular narrative of coaching ``trees'' passing down strategic DNA from mentors to protégés finds minimal empirical support for aggression. Overall composite aggression inheritance is essentially zero ($r=0.050$, $p=0.261$). Fourth down philosophy provides the sole exception: it shows modest but statistically significant inheritance ($r=0.150$, $p<0.001$), driven entirely by offensive mentors ($r=0.217$, $p<0.001$) with defensive mentors transmitting nothing ($r=-0.016$, $p=0.808$). Among coordinators, offensive coordinators transmit both fourth down philosophy ($r=0.191$, $p=0.008$) and pass-heavy tendencies ($r=0.200$, $p=0.005$) to protégés who become head coaches. Defensive coordinators transmit no detectable strategic tendencies ($r \approx 0$ for all components).
